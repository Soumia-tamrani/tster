    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)}>
        <div className="w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          <h2 className="text-2xl sm:text-2xl font-semibold text-[#013959] mb-4">
            Votre profil professionnel
          </h2>
          <p className="text-[#7E8B93] text-sm sm:text-base mb-6 sm:mb-8" style={{ fontFamily: "Poppins, sans-serif", fontSize: "13px" }}>
            Parlez-nous un peu de vous pour mieux adapter votre expérience sur Catchub.
          </p>
          <div className="flex flex-col gap-4 sm:gap-6 mb-8 sm:mb-10">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-sm sm:text-base">Secteur d'activité</FormLabel>
                  <FormControl>
                    <Select value={field.value} onValueChange={field.onChange}>
                      <SelectTrigger
                        className={cn(
                          "w-full rounded-[11px] border-[#CACACA] bg-white focus:border-[#1CD5F5] focus:ring-2 focus:ring-[#1CD5F5]/20 transition-all duration-200 ease-in-out flex items-center justify-between px-3 sm:px-4",
                          "[&>span]:flex [&>span]:items-center [&>span]:h-full text-gray-900 font-medium"
                        )}
                        style={{
                          height: "44px",
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-sm sm:text-base">Centre d'intérêt professionnel</FormLabel>
                  <FormControl>
                    <Select value={field.value} onValueChange={field.onChange}>
                      <SelectTrigger
                        className={cn(
                  ...
                  <FormControl>
                    <Select value={field.value} onValueChange={field.onChange}>
                      ...
                      <SelectContent className="max-h-60 bg-white dark:bg-gray-800 rounded-lg shadow-lg border-gray-100 dark:border-gray-700">
                        ...
                        <SelectItem value="RECHERCHE_EN_LIGNE">Moteur de recherche</SelectItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-2 space-y-0">
                  ...
                  <FormLabel
                    htmlFor="consent"
                    className="text-xs sm:text-sm text-[#7E8B93] font-normal"
                  >
                    J'accepte que mes données soient utilisées par Catchhub pour
                    créer mon compte et recevoir des communications liées à la
                    plateforme, conformément à la politique de confidentialité.
