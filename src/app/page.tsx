...
//       {/* Hero Section */}
//       <section className="w-full py-16 md:py-24 lg:py-32 bg-white dark:from-gray-900 dark:to-gray-800">
...
//   <div className="relative w-full h-[350px] md:h-[450px] rounded-2xl shadow-xl overflow-hidden group hover:shadow-blue-500/20 dark:hover:shadow-purple-500/20 transition-shadow duration-500 bg-white">
    
//     {/* Vidéo remplissant parfaitement le cadre */}
//     <video
...
//     {/* (Optionnel) retirer si tu ne veux pas la grille */}
//     {/* <div className="absolute top-0 left-0 w-full h-full bg-grid-blue-200/10 dark:bg-grid-purple-900/10 pointer-events-none" /> */}
//   </div>
// </div>
...
//             <div className="inline-flex items-center rounded-full bg-white px-4 py-1 text-sm font-medium text-[#1CD5F5] border border-[#1CD5F5] animate-fade-in" style ={{ fontFamily: 'Montserrat, sans-serif' }}>
//               Fonctionnalités
//             </div>
//             <div className="space-y-2 max-w-5xl">
//               <h3 className="text-2xl font-bold tracking-tighter md:text-[30.5px] text-[#013959] " style ={{ fontFamily: 'Montserrat, sans-serif' , letterSpacing: '0.002em' }}>
...
//             </div>
//           </div>
//           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7 mt-10 max-w-7xl mx-auto px-4">
//             {[
//               {
//                 icon: Calendar,
//                 bg: "#DFFBFF",
...
//               <div
//                 key={i}
//                   className="flex flex-col items-start justify-start space-y-5 bg-white border border-[#B4B4B4] rounded-[23px] w-full max-w-sm h-auto px-6 py-8 mx-auto hover:scale-[1.02] hover:-translate-y-1 transform"
//                     style={{
...
//                   >
//                     <feature.icon className="h-44px w-44px" style={{ color: feature.iconColor }} strokeWidth={1.3} />
//                   </div>
...
//             <h2
//               className="text-3xl font-bold tracking-tighter md:text-4xl text-[#013959] dark:text-white"
//               style={{ fontFamily: 'Montserrat, sans-serif' }}
//             >
...
//           <div className="flex flex-col justify-between bg-white dark:bg-gray-800 border shadow-lg rounded-[23px] p-6 sm:p-10 h-full hover:-translate-y-1 transition-all">
//             <div>
...
//               </div>
//               <h3 className="text-2xl font-bold mb-4 text-[#013959]">Pour les Professionnels</h3>
//               <div className="space-y-4">
//                 {[
...
//                 <div className="inline-flex items-center justify-center p-3 bg-blue-950 rounded-full hover:bg-[#005F86]">
...
//         </h2>
//         <p className="text-gray-600 dark:text-gray-300 text-lg" style={{ fontFamily: 'Montserrat, sans-serif' }}>
...
//           <div
//             key={i}
//             className={`w-full bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-blue-100 dark:border-purple-900/30 transition-all duration-300 hover:shadow-md hover:border-blue-200 dark:hover:border-purple-500/30 ${
//               i % 2 === 0 ? 'md:ml-8' : ''
//             }`}
//           >
