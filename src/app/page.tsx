          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
            ...
            <div className="flex flex-col justify-center space-y-6 text-center lg:text-left">
              <div className="space-y-4">
                ...
                >
                  La plateforme qui connecte les professionnels et les
                  entreprises pour créer des opportunités d'affaires durables.
                </p>
              </div>
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <div className="space-y-2 max-w-5xl">
              ...
              <p
                ...
                style={{ fontFamily: "Montserrat, sans-serif" }}
              >
                Découvrez comment notre plateforme peut transformer votre réseau
                professionnel et accélérer votre croissance
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <div className="space-y-2 max-w-3xl">
              ...
              <p
                ...
                style={{ fontFamily: "Montserrat, sans-serif" }}
              >
                Les avantages qui font la différence pour votre carrière ou
                votre entreprise
              </p>
            </div>
          </div>
          ...
          <div className="container px-4 md:px-6 mt-8 sm:mt-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12">
              {[
                ...
                {
                  question:
                    "Quand la plateforme sera-t-elle officiellement lancée?",
                  answer:
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-200 dark:text-gray-200">
                La plateforme qui connecte les professionnels et les entreprises
