...
export default function BusinessForm({
  ...
  // Remplacer la fonction renderProgressSteps actuelle par cette version améliorée
  const renderProgressSteps = () => {
    const steps = [
    ...
    return (
      <div className="mb-8 sm:mb-12 lg:mb-16 w-full">
        <div className="flex items-center justify-between w-full max-w-[320px] sm:max-w-[400px] md:max-w-[500px] relative mt-6 sm:mt-8 lg:mt-10 mb-6 sm:mb-8 lg:mb-10 mx-auto">
          {/* Ligne horizontale qui traverse le centre de chaque icône */}
          <div className="absolute top-1/2 h-[2px] bg-gray-200 left-0 right-0 -translate-y-1/2 z-0"></div>
  ...
  const RequiredLabel = ({
    ...
    <div className="flex items-center">
      <Label htmlFor={htmlFor} className="flex items-center text-sm font-semibold text-[#013959]">
        {children} <span className="text-red-500 ml-1">*</span>
      </Label>
      {tooltip && (
        <TooltipProvider>
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="w-full h-full flex flex-col items-center">
        <div className="text-center">{renderProgressSteps()}</div>
        {isSuccess ? (
          <motion.div
            className="flex flex-col items-start w-full max-w-[893px] px-4 sm:px-6 lg:px-0"
            style={{ padding: "0px", gap: "29px" }}
            initial="hidden"
            animate="visible"
            variants={fadeInUp}
          ...
          <>
            ...
            {step === 1 && (
              ...
              >
                <div className="mb-4 sm:mb-6">
                  <h3
                    className="text-lg sm:text-xl font-semibold text-[#013959] flex items-center mt-6 sm:mt-8 lg:mt-10 mb-2"
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                  ...
                  <p className="text-gray-500 text-sm">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eiusmod, nisi nec tincidun...
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-[29px] w-full">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      />
                      {isCheckingEmail && (
                        <Loader2 className="absolute right-3 top-3.5 text-[#1CD5F5] animate-spin" size={18} />
                      )}
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <SelectTrigger
                        className={cn(
                          "w-full rounded-[11px] border-[#CACACA] bg-white focus:border-[#1CD5F5] focus:ring-2 focus:ring-[#1CD5F5]/20 transition-all duration-200 ease-in-out flex items-center justify-between px-4",
            ...
            {step === 3 && (
              <motion.div
                className="space-y-4 sm:space-y-5 w-full max-w-[800px] px-4 sm:px-6 lg:px-0"
                initial="hidden"
                animate="visible"
                variants={fadeInUp}
              >
                <div className="mb-6 sm:mb-8">
                  <h3
                    className="text-lg sm:text-xl font-semibold text-[#013959] mb-2"
                ...
                <div className="space-y-2">
                  <Label>Comment avez-vous découvert Catchub ?</Label>
                  <Select
                    name="discoverySource"
                    value={formData.discoverySource}
                ...
                <div className="flex items-center space-x-2 mt-4">
                  <Checkbox
                    ...
                    className="border-gray-300 text-[#1CD5F5] focus:ring-[#1CD5F5] rounded"
                  />
                  <Label htmlFor="subscribedToNewsletter" className="text-sm text-[#013959]">
                    Je souhaite recevoir des informations sur les événements et opportunités
                  </Label>
                </div>

                <div className="flex flex-col sm:flex-row justify-between items-center mt-6 w-full gap-4 sm:gap-0">
                  {/* Bouton Retour à gauche */}
                  <div>
                    <Button
                      type="button"
