...
const NewsletterSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setSuccessMessage(
          data.message ||
            "Merci de vous être abonné à notre newsletter. Vous recevrez bientôt nos dernières mises à jour."
        );
        setEmail("");
  ...
  return (
    <section className="w-full bg-[#1CD5F529] py-4">
      <div className="max-w-screen-xl mx-auto px-4 md:px-8 h-auto md:h-[298px] flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6 md:gap-8 lg:gap-10 xl:gap-[60px]">
        {/* Texte */}
        <div className="text-left w-full max-w-full sm:max-w-md md:max-w-lg lg:max-w-xl">
          ...
          >
            Inscrivez-vous à notre newsletter pour recevoir nos actualités exclusives en avant-première.
          </p>
        </div>
